...
<div class="grid grid-cols-1 md:grid-cols-3 gap-6">
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        ...
        <div class="mt-4">
            <a href="{{ route('admin.dashboard') }}" class="text-blue-500 hover:text-blue-700 text-sm">View Details &rarr;</a>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        ...
        <div class="mt-4">
            <a href="{{ route('admin.complaints.index') }}" class="text-red-500 hover:text-red-700 text-sm">View Complaints &rarr;</a>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        ...
        <div class="mt-4">
            <a href="{{ route('admin.expenses.index') }}" class="text-green-500 hover:text-green-700 text-sm">View Expenses &rarr;</a>
        </div>
    </div>
</div>
