    ...
    <form id="addon-sale-form" action="{{ route('cashier.sales.store-addon-only') }}" method="POST">
                ...
                <div class="border rounded-lg p-4 hover:bg-blue-50 transition">
                    ...
                    <div class="mt-3 flex items-center">
                        ...
                        <input type="number" 
                               ...
                               min="0" 
                               step="0.5" 
                               class="border rounded w-16 p-1 text-center addon-qty" 
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <label class="inline-flex items-center">
                                <input type="radio" name="payment_method" value="{{ $code }}" 
                                       class="form-radio payment-method" 
                    ...
                    <div id="lbp-payment-section" class="mb-4">
                        ...
                        <input type="text" name="amount_paid" id="amount-paid-lbp" class="border rounded p-2 w-full" value="0" oninput="validateForm()">
                    </div>
                    ...
                    <div id="usd-payment-section" class="mb-4 hidden">
                        ...
                        <input type="text" name="amount_paid" id="amount-paid-usd" class="border rounded p-2 w-full" value="0" oninput="validateForm()">
                    </div>
                </div>
            ...
            <div class="mt-6 flex justify-end">
                <a href="{{ route('cashier.sales.index') }}" class="bg-gray-200 text-gray-700 px-4 py-2 rounded mr-2 hover:bg-gray-300">
                    Cancel
                </a>
                <button type="submit" id="submit-btn" class="bg-primary text-white px-4 py-2 rounded hover:bg-primary-dark">
                    Complete Sale
                </button>
            </div>
        </div>
...
<script>
    ...
    function updateOrderSummary() {
        ...
        if (!hasItems) {
            orderSummary.innerHTML = '<p class="text-gray-500 italic text-center" id="no-items-message">No add-ons selected</p>';
        }
